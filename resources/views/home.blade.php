            ...
            <div class="col-md-5">
                <div class="home-content display-table">
                    <div class="display-table-cell">
                        <h2 class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">Welcome to </br>Uwelling
                            Accademy</h2>
                        <div class="wow fadeInLeft">
                            <p data-wow-duration="1.5s" data-wow-delay="1s">PROVA TUTTI I MERAVIGLIOSI SERVIZI E SCEGLI
                                TRA</p>
                            <div>
                        ...
                        <p class="wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay="1.5s">UWELLING ACCADEMY NASCE
                            DAL DESIRERIO DI OFFRIRE SERVIZI UNICI PER CREARE MENTI E CORPI PIU CONSAPEVOLI DEL PROPRIO
                            BENESSERE</p>
                ...
                <div class="service one">
                    ...
                    <div class="service-item">
                        ...
                        <p>Un team di professionisti esperti in coaching in vari settori ti riprogrammeranno per
                            consentirti di essere autonomo a 360°, per riprendere in mano la tua vita ed aumentare le
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="service two">
                    ...
                    <div class="service-item">
                        ...
                        <p>Verrai sottoposto a varie metodologie di riprogrammazione sul fronte sia mentale che fisico
                            per raggiungere la tua versione migliore ed ottenere un boost di performance lavorativo e
                            personale.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="service three">
                    ...
                    <div class="service-item">
                        ...
                        <p>Avrai accesso a diverse classi d’allenamento per ricondizionare il tuo corpo e la tua psiche
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="service four">
                    ...
                    <div class="service-item">
                        ...
                        <p>Potrai richiedere o usufruire di percorsi personalizzati per raggiungere specifiche skill su
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="service five">
                    ...
                    <div class="service-item">
                        ...
                        <p>Potrai accedere ai nostri corsi sottoscrivendo una VIP MEMBERSHIP per poter visione tutto il
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="service six">
                    ...
                    <div class="service-item">
                        ...
                        <p>Potrai partecipare ai nostri eventi esclusivi per progredire con il tuo percorso evolutivo da
                    ...
                    <div class="pricing-plan">
                        <div class="pricing-head">
                            ...
                            <div class="pricing-price">
                                <p><span class="up">$</span> <span class="price">50</span> <span class="down">/Mo</span>
                                </p>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="pricing-plan two">
                        <div class="pricing-head">
                            ...
                            <div class="pricing-price">
                                <p><span class="up">$</span> <span class="price">100</span> <span
                                        class="down">/Mo</span></p>
                            </div>
                        </div>
                        <ul class="pricing-features list-unstyled">
                            <li>Special Class</li>
                ...
                <div class="col-lg-4 offset-lg-0 col-md-6 offset-md-3">
                    <div class="pricing-plan">
                        <div class="pricing-head">
                            ...
                            <div class="pricing-price">
                                <p><span class="up">$</span> <span class="price">170</span> <span
                                        class="down">/Mo</span></p>
                            </div>
                        </div>
                        <ul class="pricing-features list-unstyled">
